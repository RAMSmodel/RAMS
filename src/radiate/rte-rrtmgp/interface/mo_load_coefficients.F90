...
contains
  ...
  subroutine load_and_init(kdist, filename, available_gases)
    ...
    integer, dimension(:),            allocatable :: minor_scales_with_density_lower, minor_scales_with_density_upper
    ...
    minor_scales_with_density_lower &
                      = read_field(ncid, 'minor_scales_with_density_lower', nminor_absorber_intervals_lower)
    minor_scales_with_density_upper &
                      = read_field(ncid, 'minor_scales_with_density_upper', nminor_absorber_intervals_upper)
    scale_by_complement_lower &
                      = read_field(ncid, 'scale_by_complement_lower', nminor_absorber_intervals_lower)
    scale_by_complement_upper &
                      = read_field(ncid, 'scale_by_complement_upper', nminor_absorber_intervals_upper)
    scaling_gas_lower &
