...
module mo_gas_optics_rrtmgp
  ...
  type, extends(ty_gas_optics), public :: ty_gas_optics_rrtmgp
    ...
    !
    integer,     dimension(:), allocatable :: minor_scales_with_density_lower, &
                                              minor_scales_with_density_upper
    integer,     dimension(:), allocatable :: scale_by_complement_lower, scale_by_complement_upper
...
contains
  ...
  function gas_optics_int(this,                             &
    ...
    integer,     dimension(size(play,dim=1), size(play,dim=2)) :: tropo
...
!
  ...
  function load_int(this, available_gases, gas_names, key_species,  &
    ...
    integer,            dimension(:,:),     intent(in   ) :: minor_limits_gpt_lower, &
                                                             minor_limits_gpt_upper
    integer,            dimension(:),       intent(in   ) :: minor_scales_with_density_lower, &
                                                             minor_scales_with_density_upper
    character(len=*),   dimension(:),       intent(in   ) :: scaling_gas_lower, &
                                                             scaling_gas_upper
    integer,            dimension(:),       intent(in   ) :: scale_by_complement_lower,&
                                                             scale_by_complement_upper
...
! ---------------------------------------------------------------------------------------
  ...
  subroutine reduce_minor_arrays(available_gases, &
    ...
    integer,          dimension(:),     intent(in) :: minor_scales_with_density_atm
    character(len=*), dimension(:),     intent(in) :: scaling_gas_atm
    integer,          dimension(:),     intent(in) :: scale_by_complement_atm
